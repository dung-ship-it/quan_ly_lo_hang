...
if ($id) {
    ...
    $stmt->bind_param('issddddddsdddddssssi', $khId,$houseBl,$congTy,$soToKhai,$thue,$phiThc,$phiLenh,$moTk,$kiem,$giamSat,$bocXep,$handling,$xeOm,$xeBus,$chiNgoai,$lyDoChiNgoai,$vanChuyen,$congTyVC,$bienSo,$id);
} else {
    ...
    $stmt->bind_param('isiissddddddsdddddsss', $userId,$ngay,$stt,$khId,$houseBl,$congTy,$soToKhai,$thue,$phiThc,$phiLenh,$moTk,$kiem,$giamSat,$bocXep,$handling,$xeOm,$xeBus,$chiNgoai,$lyDoChiNgoai,$vanChuyen,$congTyVC,$bienSo);
}
